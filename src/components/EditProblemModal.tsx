...
interface EditProblemModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdate: (id: string, problemData: Partial<Omit<Problem, 'id'>>) => void;
  problem: Problem;
...
export const EditProblemModal = ({ isOpen, onClose, onUpdate, problem, members }: EditProblemModalProps) => {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white w-full max-w-md rounded-2xl p-6 shadow-xl animate-in slide-in-from-bottom duration-300">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900">Edit Problem</h2>
